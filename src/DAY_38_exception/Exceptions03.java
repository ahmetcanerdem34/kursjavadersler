...
public class Exceptions03 {
	...
	public static void main(String[] args) {
		...
		//exceptions nedir ?  Javanin karsilastigi handle çözülebilir problemlerdir desek yeterli mi yani hocam
		//programlar calisirken ortaya cikan istisnai durumlar
